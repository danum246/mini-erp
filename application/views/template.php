...
<head>
   ...
   <link href="<?php echo base_url(); ?>assets/plugin/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" />
   <link href="<?php echo base_url(); ?>assets/plugin/bootstrap/css/bootstrap-fileupload.css" rel="stylesheet" />
   ...
   <link href="<?php echo base_url(); ?>assets/plugin/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
   <link href="<?php echo base_url(); ?>assets/plugin/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="fixed-top">
       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <a class="brand" href="index.html">
                   <img src="<?php echo base_url(); ?>assets/img/logo.png" alt="Mini ERP" />
               </a>
               <!-- END LOGO -->
   ...
   <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/jquery-slimscroll/jquery-ui-1.9.2.custom.min.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/jquery-slimscroll/jquery.slimscroll.min.js"></script>
   <script src="<?php echo base_url(); ?>assets/plugin/fullcalendar/fullcalendar/fullcalendar.min.js"></script>
   ...
   <script src="<?php echo base_url(); ?>assets/plugin/jquery-easy-pie-chart/jquery.easy-pie-chart.js" type="text/javascript"></script>
   <script src="<?php echo base_url(); ?>assets/js/jquery.sparkline.js" type="text/javascript"></script>
   <script src="<?php echo base_url(); ?>assets/plugin/chart-master/Chart.js"></script>
